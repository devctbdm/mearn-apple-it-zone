      ...
      >
        <Card className="border border-border/60 shadow-2xl shadow-primary/5">
          <CardContent className="flex flex-col items-center px-8 py-12 text-center">
            ...
            <motion.p
              variants={itemVariants}
              className="text-muted-foreground mt-3 max-w-xs text-sm"
            >
              ...
              <div className="flex items-center justify-between">
                ...
                >
                  ...
                  {copied ? (
                    ...
                    <Copy className="text-muted-foreground group-hover:text-foreground size-3.5 transition-colors" />
                  )}
                </button>
              </div>
              <div className="flex items-center justify-between">
